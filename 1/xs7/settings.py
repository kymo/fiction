# Django settings for xs7 project.
...
SECRET_KEY = '07i3q!96@iye0iq8p7f!lzd^3tjy2-ecwlcd9)39m#%6^!v=p1'
...
ROOT_URLCONF = 'xs7.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'xs7.wsgi.application'
